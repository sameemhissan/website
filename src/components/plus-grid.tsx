  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 top-2 border-t border-white/40"></div>
        <div className="absolute inset-x-0 bottom-0 hidden border-b border-white/20 group-last/row:block"></div>
        <div className="absolute inset-x-0 bottom-2 hidden border-b border-white/40 group-last/row:block"></div>
        {/* previousely used:  `border-black/5` */}
      </div>
      {children}
    </div>
  )
...
export function PlusGridIcon({
  ...
  return (
    <svg
      ...
      className={clsx(
        className,
        'absolute size-[15px] fill-white/50',
        yClass,
        xClass,
      )}
    >
