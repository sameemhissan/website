  ...
  return (
    <FadeIn>
      ...
      <p className="mt-6 text-base text-neutral-600">
        Prefer doing things in person? Feel Free to reach out to us.
      </p>
      ...
      <Border className="mt-16 pt-16">
        ...
        <dl className="mt-6 grid grid-cols-1 gap-8 text-sm sm:grid-cols-1">
          {[
            ['Sales', 'sales@hissan-aero.com'],
            ['Phone no.', '+971 588001609'],
          ].map(([label, email]) => (
            <div key={email}>
    ...
    <>
      ...
      <section id="contact">
        ...
        <Container className="mt-20 sm:mt-32 lg:mt-4">
          <div className="relative grid grid-cols-1 gap-x-8 gap-y-2 lg:grid-cols-2">
            {/* First Grid */}
